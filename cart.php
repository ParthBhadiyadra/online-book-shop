...
{
    echo "<script> alert('Successfully payment done'); </script>";
                    ...
                    if(isset($_COOKIE['user_cart'])){
                        ...
                        <?php    } ?>
                                ...
                                <form action="instamojo.php" class="checkout-form pull-right" method="POST">
                                    ...
                                    <input type="radio" name="type" value="buy" checked> Buy &nbsp; <input type ="radio" name="type" value="rent"> Rent <br>
                                    <input type="submit" class="btn btn-md btn-success"  name="Checkout" style="margin-top:20px;" value="Proceed to Checkout">
